...
class NewCategory extends StatefulWidget {
  const NewCategory({Key? key, required this.listOfIncomeCategory}) : super(key: key);
                  ...
                  Center(
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            if (categoryNameController.text != '' && !names.contains(categoryNameController.text.toLowerCase().removeAllWhiteSpace())) {
